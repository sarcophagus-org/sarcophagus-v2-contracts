// Unmodified from copied version
// https://github.com/mudgen/diamond-1-hardhat/blob/main/test/cacheBugTest.js
...
const {
  deployDiamond,
} = require("../../contracts/diamond/scripts/deploy-diamond");

const {
  FacetCutAction,
} = require("../../contracts/diamond/scripts/libraries/diamond.js");
