...
describe("ArchaeologistFacet.depositFreeBond", () => {
  ...
  it("should deposit free bond", async () => {
    ...
    await expect(tx).to.emit(archaeologistFacet, `DepositFreeBond`);
  });
