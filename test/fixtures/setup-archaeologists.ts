...
import { FixtureArchaeologist } from "../../types";

export const setupArchaeologists = deployments.createFixture(
  async ({
    deployments,
    getNamedAccounts,
    getUnnamedAccounts,
    ethers,
  }): Promise<FixtureArchaeologist[]> => {
    ...
    return [
      ...
      },
      {
        ...
        signer: await ethers.getSigner(unnamedAccounts[4]),
